...
void Mixer ::arm() {
  ...
  while (i > 0) {
    ...
    int noteIndex = 0;
    int melodia[] = {150, 660 , 300, 660 ,300, 510 , 100, 660 , 300, 770, 660, 300 , 660, 300 , 510, 100 , 660, 300 , 770, 550, 300, 660 , 300, 510 , 100, 660 , 300, 770 , 550, 380, 660, 300 , 510, 100 , 660, 300 , 770, 550 , 380, 575};
